...
<div class="container d-flex justify-content-center align-items-center min-vh-100 position-relative">
    <div class="form-container">
        <form class="modal-content animate" id="frm_register" method="post" action="{{ route('sendotplogin') }}">
            @csrf
            <header>
            ...
            <div class="wrapper">
                ...
                <input type="text" name="forgot_email" value="{{ old('forgot_email') }}" aria-describedby="usernameHelp"
            ...
            <!-- <button type="submit" class="rounded-3 btn-submit"><a href="{{ route('sendotplogin') }}">Submit</a></button> -->
        </form>
    </div>
</div>
</div>
