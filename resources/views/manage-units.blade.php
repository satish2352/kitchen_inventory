                ...
                @if (!empty($unit_data) && count($unit_data) > 0)
                    <table class="table table-striped" id="inventoryTable">
                        ...
                        <thead class="table-header">
                            <tr>
                                <th onclick="sortTable('inventoryTable', 0)"><b>Sr. No. <i class="bi bi-arrow-up"
                                            id="arrow-0"></i></b></th>
                                <!-- <th><b>Date</b></th> -->
                                <th onclick="sortTable('inventoryTable', 1)"><b>Units <i class="bi bi-arrow-up"
                                            id="arrow-1"></i></b></th>
                                <th><b>Action</b></th>
                            </tr>
                        </thead>
                        ...
                        <tbody id="search-results">
                            ...
                            @foreach ($unit_data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn text-center shadow-sm btn-sm edit-btn-unit mu-edit"
                                            data-id="{{ $item->id }}">
                                    ...
                                    <ul class="pagination">
                                        <li class="{{ $unit_data->currentPage() == 1 ? ' disabled' : '' }}">
                                            @if ($unit_data->currentPage() > 1)
                                                <a
                                                    href="{{ $unit_data->url($unit_data->currentPage() - 1) }}">Previous</a>
                                            @else
                                                <span>Previous</span>
                                            @endif
                                        </li>
            ...
            <form class="forms-sample" id="frm_register" name="frm_register" method="post" role="form"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <input type="text" class="form-control" placeholder="Unit" name="unit_name"
        ...
        <div class="popup-content">
            <form class="forms-sample" id="editUnitForm" name="editUnitForm" method="post" role="form"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 col-sm-12 col-lg-6">
                        <input type="text" class="form-control" placeholder="Unit" name="unit_name"
                            id="unit_id" style="text-transform: capitalize;" />
    ...
    <div class="popup-content">
        <form class="forms-sample" id="editUnitForm" name="editUnitForm" method="post" role="form"
            ...
            <div class="row mb-3">
                <label class="col-md-6 col-sm-12 col-lg-6 form-label">Unit</label>
                <div class="col-md-6 col-sm-12 col-lg-6">
                    <input type="text" class="form-control" placeholder="Unit" name="unit_name" id="unit_id"
                        style="text-transform: capitalize;" />
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        // Display new errors
                        if (errors.unit_name) {
                            $('input[name="unit_name"]').after(
                                '<span class="text-danger">' + errors.unit_name[0] +
                                '</span>');
                        }
