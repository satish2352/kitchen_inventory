...
<div class="main">
    ...
    <div id="addPopup" class="popup-container">
        <div class="popup-content">
            ...
            <form class="forms-sample" id="frm_register_add" name="frm_register" method="post"
                    ...
                    error: function(xhr) {
                        ...
                        if (errors) {
                            $.each(errors, function(key, value) {
                                ...
                                inputField.after('<span class="error-text">' +
                                    value[0] + '</span>');
                ...
                error: function(xhr) {
                    ...
                    $.each(errors, function(key, messages) {
                        $('input[name="' + key + '"], select[name="' + key + '"]')
                            .after('<span class="text-danger">' + messages[0] +
                                '</span>');
                    });
